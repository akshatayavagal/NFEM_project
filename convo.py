...
def material_routine(lemda,mue,strain_current,elemental_plastic_strain,sigma_yield):
    ...
    if phi_cal<=0:
        ...
        # Ct = np.zeros([3, 3])
        # Ct[0, 0] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) + (2*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)*mue) - (((3*mue)/(sigma_equi_trial)**2) * sigma_trial_devi[0] * sigma_trial_devi[0])
        # Ct[1, 1] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) + (2*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)*mue) - (((3*mue)/(sigma_equi_trial)**2) * sigma_trial_devi[1] * sigma_trial_devi[1])
        # Ct[2, 2] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) + (2*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)*mue) - (((3*mue)/(sigma_equi_trial)**2) * sigma_trial_devi[2] * sigma_trial_devi[2])
        # Ct[0, 1] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) - ((3 * mue)/(sigma_equi_trial**2)*(sigma_trial_devi[0]*sigma_trial_devi[1]))                                       ## changed from lambda to ...
        # Ct[0, 2] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) - ((3 * mue)/(sigma_equi_trial**2)*(sigma_trial_devi[0]*sigma_trial_devi[2]))                                        ## changed from lambda to ...
        # Ct[1, 0] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) - ((3 * mue)/(sigma_equi_trial**2)*(sigma_trial_devi[1]*sigma_trial_devi[0]))                                        ## changed from lambda to ...
        # Ct[1, 2] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) - ((3 * mue)/(sigma_equi_trial**2)*(sigma_trial_devi[1]*sigma_trial_devi[2]))                                        ## changed from lambda to ...
        # Ct[2, 0] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) - ((3 * mue)/(sigma_equi_trial**2)*(sigma_trial_devi[2]*sigma_trial_devi[0]))                                        ## changed from lambda to ...
        # Ct[2, 1] = ((k_value/3) - ((2*mue)/3)*((sigma_equi_trial - 3 * mue * delta_lemda)/sigma_equi_trial)) - ((3 * mue)/(sigma_equi_trial**2)*(sigma_trial_devi[2]*sigma_trial_devi[1]))
...
plt.savefig("elastic_convergence_12")   
plt.show()
